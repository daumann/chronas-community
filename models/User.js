...
User.add({
	...
	isAdmin: { type: Boolean, label: 'Can Admin Chronas' },
    ...
    lastLogin: { type: Number, default: new Date().getTime(), noedit: true },
    loginCount: { type: Number, default: 1, noedit: true },
    commentsCount: { type: Number, default: 0, noedit: true },
    ratingsCount: { type: Number, default: 0, noedit: true },
	threadCount: { type: Number, default: 0, noedit: true },
    c_modCount: { type: Number, default: 0, noedit: true },
    c_timeSpent: { type: Number, default: 0, noedit: true },
    idParticipated: { type: String, default: "", noedit: true },
    badgeList: { type: String, default: 0, noedit: true },
...
User.schema.methods.resetPassword = function(callback) {
	...
	user.save(function(err) {
		...
		new keystone.Email('forgotten-password').send({
			...
			subject: 'Reset your Chronas Password',
			to: user.email,
			from: {
				name: 'Chronas',
				email: 'noreply@chronas.org'
			}
		}, callback);
